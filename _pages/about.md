...
### <a name="TANDEM"></a> 2. **(Preprint 2022)** **Active Tactile Exploration for 3D Object Recognition**
...
### <a name="Toeplitz"></a> 3. **(ICML 2022)** **From block-Toeplitz matrices to differential equations on graphs: towards a general theory for scalable masked Transformers**
...
### <a name="HRF"></a> 4. **(ICLR 2022)** **Hybrid Random Features**
...
### <a name="GKAT"></a> 5. **(Preprint 2021)** **Graph Kernel Attention Transformers**
...
### <a name="OMC"></a> 6. **(NeurIPS 2020)** **Demystifying Orthogonal Monte Carlo and Beyond**
